...
const WHATSAPP_NUMBER = "5537996704294";
    ...
    <div className="fixed bottom-10 right-10 z-[60] flex flex-col items-end">
      ...
      <div className="relative group">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className={`p-5 rounded-[2rem] shadow-2xl transition-all duration-500 flex items-center justify-center ${isOpen ? 'bg-zinc-800 text-cyan-400 rotate-90' : 'bg-emerald-500 text-white shadow-[0_20px_50px_rgba(16,185,129,0.3)]'
            }`}
        >
          {isOpen ? (
